...
public class ViewdCategoryAdapter extends RecyclerView.Adapter<ViewdCategoryAdapter.MasterFragmentViewHolder> {
    ArrayList<POJOValue> arrayList = new ArrayList<>();
    ViewedCategoryFragment viewedtgFragment;
    String ContextView;
    Context context;
    Activity activity;
    ...
    public ViewdCategoryAdapter(ArrayList<POJOValue> arrayList, String contextView, Context context, ViewedCategoryFragment visited_catgFragment) {
